...
import seedu.friendbook.model.person.exceptions.PersonNotFoundException;
...
public class UniquePersonList implements Iterable<Person> {
    ...
    /**
     * Returns true if the list contains an existing phone number
     */
    public boolean hasExistingPhoneNumber(Person toCheck) {
        requireNonNull(toCheck);
        return internalList.stream().anyMatch(x -> x.getPhone().equals(toCheck.getPhone()));
    }

    /**
     * Returns true if the list contains an existing Email
     */
    public boolean hasExistingEmail(Person toCheck) {
        requireNonNull(toCheck);
        return internalList.stream().anyMatch(x -> x.getEmail().equals(toCheck.getEmail()));
    }
