        ...
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                ...
                getTagSet("friends"), new Birthday("1998-03-16"), new TeleHandle("@alexi"),
                    new Description("good friend"), new Picture("alex_yeoh"), new Reminder("on")),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                getTagSet("colleagues", "friends"), new Birthday("1994-07-20"),
                    new TeleHandle("@bert"), new Description("good friend"), new Picture("bernice_yu"),
                    new Reminder("on")),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                getTagSet("neighbours"), new Birthday("1999-06-10"), new TeleHandle("@cherry"),
                    new Description("good friend"), new Picture("charlotte_oliverio"), new Reminder("on")),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                getTagSet("family"), new Birthday("1992-09-24"), new TeleHandle("@davelord"),
                    new Description("good friend"), new Picture("david_li"), new Reminder("on")),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"),
                getTagSet("classmates"), new Birthday("1985-02-25"), new TeleHandle("@irfan"),
                    new Description("good friend"), new Picture("irfan_ibrahim"), new Reminder("on")),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"),
                getTagSet("colleagues"), new Birthday("1994-11-28"), new TeleHandle("@roy"),
                    new Description("good friend"), new Picture("roy_balakrishnan"), new Reminder("on"))
        };
    }
