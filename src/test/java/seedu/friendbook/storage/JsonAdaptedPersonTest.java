...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_PICTURE = "pic?><242";
    ...
    private static final String VALID_TELEHANDLE = "johndoe";
    private static final String VALID_DESCRIPTION = "AWESOME GUY!";
    private static final String VALID_PICTURE = "john_doe";
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_TAGS, VALID_BIRTHDAY, VALID_TELEHANDLE, VALID_DESCRIPTION, VALID_PICTURE);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_BIRTHDAY, VALID_TELEHANDLE, VALID_DESCRIPTION, VALID_PICTURE);
    ...
    public void toModelType_invalidBirthday_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_TAGS, INVALID_BIRTHDAY, VALID_TELEHANDLE, VALID_DESCRIPTION, VALID_PICTURE);
    ...
    public void toModelType_nullBirthday_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        null, VALID_TELEHANDLE, VALID_DESCRIPTION, VALID_PICTURE);
    ...
    public void toModelType_invalidTeleHandle_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_TAGS, VALID_BIRTHDAY, INVALID_TELEHANDLE, VALID_DESCRIPTION, VALID_PICTURE);
    ...
    public void toModelType_nullTeleHandle_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_BIRTHDAY, null, VALID_DESCRIPTION, VALID_PICTURE);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_TAGS, VALID_BIRTHDAY, VALID_TELEHANDLE, INVALID_DESCRIPTION, VALID_PICTURE);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_BIRTHDAY, VALID_TELEHANDLE, null, VALID_PICTURE);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT,
    ...
    public void toModelType_invalidPicture_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_TAGS, VALID_BIRTHDAY, VALID_TELEHANDLE, VALID_DESCRIPTION, INVALID_PICTURE);
    ...
    public void toModelType_nullPicture_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                        VALID_BIRTHDAY, VALID_TELEHANDLE, VALID_DESCRIPTION, null);
        String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT,
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        invalidTags, VALID_BIRTHDAY, VALID_TELEHANDLE, VALID_DESCRIPTION, VALID_PICTURE);
