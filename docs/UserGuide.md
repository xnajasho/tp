...
1. Download the latest `friendbook.jar` from [here](https://github.com/AY2122S1-CS2103-F10-3/tp/releases/tag/v1.2.1).
...
Examples:
* `list` followed by `delete 2` deletes the 2nd person in the friend book.
